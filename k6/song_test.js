...
export default function () {
  ...
  const getSongsOk = check(getSongsRes, {
    ...
    'getSongs returns array':   (r) => Array.isArray(r.json()),
  });
  ...
  // Get user's songs
  const userSongsRes = http.get(`${BASE_URL}/api/song/getUserSongs`, authHeader);
  ...
  const userSongsOk = check(userSongsRes, {
    ...
    'getUserSongs returns array': (r) => Array.isArray(r.json()),
  });
